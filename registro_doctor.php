...
<head>
	...
	<title>Registro Veterinarios</title>
</head>
...
<body background="img/blanco.jpg">
	...
	<div class="container">
      ...
      <header>	  	  
		...
		<div class="form__top">
			<h2>Registro <span>Veterinarios</span></h2>
		</div>		
		...
		<form class="form__reg" action='base_datos.php' method='POST'>
			...
			<input class="input" name="cedula" type="text" placeholder="&#128101;  Cedula profesional" value="<?php echo $cedula;?>" required>			
            ...
            <input type='hidden' name='opcion' id='opcion' value='registro_doctor'>
			<div class="btn__form">
